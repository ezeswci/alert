...
function eviarMensaje(con_id, con_tipo, con_nombre, con_destino){
	//alert("Sale Sms");
	message="Esto es un Mensaje de la App Device Track entra en este link para seguirme: http://45.79.140.250/monitoreo/vehiculos_posicion_direct_cel.php?gps="+window.celCode;
		var options = {
...
function enviarMails(destinos) {
	//alert("Sale Mail");
	msj="Esto es un Mensaje de la App Device Track entra en este link para seguirme: http://45.79.140.250/monitoreo/vehiculos_posicion_direct_cel.php?gps="+window.celCode;
	window.plugin.email.open({
    to:      destinos,
    cc:      [''],
    bcc:     [''],
    subject: 'Mensaje de la App Device Track',
    body:    msj
});
}